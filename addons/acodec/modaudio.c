...
static bool _al_identify_stm(ALLEGRO_FILE *f)
{
   ...
   uint8_t x[8];
   if (!al_fseek(f, 0x14, ALLEGRO_SEEK_CUR))
      return false;
   if (al_fread(f, x, 8) < 8)
      return false;
...
bool _al_register_dumb_loaders(void)
{
   ...
   ret &= al_register_audio_identifier(".669", _al_identify_669);
   ...
   ret &= al_register_audio_identifier(".amf", _al_identify_amf);
   ...
   ret &= al_register_audio_identifier(".asy", _al_identify_asy);
   ...
   ret &= al_register_audio_identifier(".it", _al_identify_it);
   ...
   ret &= al_register_audio_identifier(".mod", _al_identify_mod);
   ...
   ret &= al_register_audio_identifier(".mtm", _al_identify_mtm);
   ...
   ret &= al_register_audio_identifier(".okt", _al_identify_okt);
   ...
   ret &= al_register_audio_identifier(".psm", _al_identify_psm);
   ...
   ret &= al_register_audio_identifier(".ptm", _al_identify_ptm);
   ...
   ret &= al_register_audio_identifier(".riff", _al_identify_riff);
   ...
   ret &= al_register_audio_identifier(".s3m", _al_identify_s3m);
   ...
   ret &= al_register_audio_identifier(".stm", _al_identify_stm);
   ...
   ret &= al_register_audio_identifier(".xm", _al_identify_xm);
#else
   /*
