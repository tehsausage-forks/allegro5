...
bool al_init_acodec_addon(void)
{
   ...
   ret &= al_register_audio_identifier(".wav", _al_identify_wav);

   /* buil-in VOC loader */
   ret &= al_register_sample_loader(".voc", _al_load_voc);
   ret &= al_register_sample_loader_f(".voc", _al_load_voc_f);
   ret &= al_register_audio_identifier(".voc", _al_identify_voc);
   ...
   ret &= al_register_audio_identifier(".flac", _al_identify_flac);
#endif
   ...
   ret &= al_register_audio_identifier(".ogg", _al_identify_ogg_vorbis);
#endif
   ...
   ret &= al_register_audio_identifier(".opus", _al_identify_ogg_opus);
#endif
   ...
   ret &= al_register_audio_identifier(".mp3", _al_identify_mp3);
#endif
